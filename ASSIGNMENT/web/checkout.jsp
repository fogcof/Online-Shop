                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <a href="cart" style="color: black"><i class="fal fa-shopping-bag active"></i></a>
                                <c:if test="${cookie.cart==null || requestScope.status eq 'done'}">
                                <span class='badge badge-warning' id='lblCartCount'/>
                            </c:if>
                            <c:if test="${cookie.cart!=null && requestScope.status ne 'done'}">
                ...
                <div class="row">
                    <div class="col-12">
                        <c:if test="${requestScope.mess!=null}">
                            <h1 style="color: red; text-align: center;">${requestScope.mess}</h1>
                            <h3 style="margin-bottom:260px;text-align: center;"><a style="text-decoration: none;font-weight: 500;color: red" href="shop">Cửa Hàng</a></h3>
                        </c:if>
                        <c:if test="${requestScope.mess==null}">
                            <div class="form-container">
                                ...
                                <form id="RegForm" action="checkout" method="post">
                                    <table>
                                        <tr>
                                            <th>Total</th>
                                            <td><input type="text" readonly placeholder="Total" name="total" value="${requestScope.total}"></td>
                                        </tr>
                                        <tr>
                                            <th>Address</th>
                                            <td><input type="text" placeholder="Adress" required name="address" value=""></td>
                                        </tr>
                                        <tr>
                                            <th>Description</th>
                                            <td><input type="text" placeholder="Description" name="desc" value=""></td>
                                        </tr>
                                    </table>

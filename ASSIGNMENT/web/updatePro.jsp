                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-container">
                            ...
                            <form id="RegForm" action="updatepro" method="post">
                                <table>
                                    <tr>
                                        <th>ID</th>
                                        <td><input type="text" placeholder="Id" name="id" readonly value="${p.id}"></td>
                                    </tr>
                                    <tr>
                                        <th>Name</th>
                                        <td><input type="text" placeholder="Name" required name="name" value="${p.name}"></td>
                                    </tr>
                                    <tr>
                                        <th>Description</th>
                                        <td><input type="text" placeholder="Description" required name="desc" value="${p.desc}"></td>
                                    </tr>
                                    <tr>
                                        <th>Image</th>

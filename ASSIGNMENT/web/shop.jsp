                    ...
                    <nav class="col-12" aria-label="...">
                        <ul class="pagination mt-5">
                            <li class="page-item ${page==1?"disabled":""}">
                                <a class="page-link" href="shop?page=${page-1}<c:if test="${cid!=null}">&cid=${cid}</c:if>">Trước</a>
                                </li>
                            <c:forEach begin="1" end="${requestScope.num}" var="num">
                                <li class="page-item <c:if test="${num==page}">active</c:if>">
                                    <a class="page-link" href="shop?page=${num}<c:if test="${cid!=null}">&cid=${cid}</c:if>">${num}</a>
                                    </li>
                            </c:forEach>
                            <li class="page-item ${page==num?"disabled":""}">
                                <a class="page-link" href="shop?page=${page+1}<c:if test="${cid!=null}">&cid=${cid}</c:if>">Sau</a>
                            </li>
                        </ul>
                    </nav>
                </div>

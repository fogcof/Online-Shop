                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-container">
                            ...
                            <form id="RegForm" action="updatecus" method="post">
                                <table>
                                    <tr>
                                        <th>Email</th>
                                        <td><input type="email" placeholder="Email" required name="email" value="${a.email}"></td>
                                    </tr>
                                    <tr>
                                        <th>Username</th>
                                        <td><input type="text" placeholder="Username" readonly name="user" value="${a.username}"></td>
                                    </tr>
                                    <tr>
                                        <th>Password</th>
                                        <td><input type="text" placeholder="Password" required name="pass" value="${a.password}"></td>
                                    </tr>
                                    <tr>
                                        <th>Phone</th>
                                        <td><input type="text" placeholder="Phone" name="phone" value="${a.phone}"></td>
                                    </tr>
                                    <tr>
                                        <th>Address</th>    
                                        <td><input type="text" placeholder="Address" name="address" value="${a.address}"></td>
                                    </tr>
                                </table>
